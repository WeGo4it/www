    ...
    return (
        <div className="flex items-center gap-2">
            <svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M45 45H5.39604V20.7576H45V28.8384H14.1089V36.9192H29.1584V32.8788H45V45Z" fill="#04E4AC"/>
                <path d="M44.802 5V16.9192H36.8812V5H44.802Z" fill="#04E4AC"/>
                <path d="M28.7624 5V16.9192H21.0396V5H28.7624Z" fill="#04E4AC"/>
                <path d="M12.9208 16.9192H5V5H12.9208V16.9192Z" fill="#04E4AC"/>
                </svg>
            <span className="text-2xl font-bold text-primary">WeGo4it</span>
        </div>
    )
}
